...
A continuación se extraen usando la librería `sf`y se define el sistema de coordenadas de referencia con base en la información suministrada en la url general que proporciona información de las capas.
