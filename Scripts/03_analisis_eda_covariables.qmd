...
precip_media_espacial <- chirps_daily$mean()$rename("precip_media_espacial")
...
registro_lst_esp <- procesamiento_lotes_imagen(ucs_sf_4326, image = lst_media_espacial, start_idx = 25294, max_index = 25593, batch_s = 50, reduce_batch_by = 3, variable_name = "LST_media_espacial", scale = 50)

registro_lst_temp <- procesamiento_lotes_imagen(ucs_sf_4326, image = lst_temp_cv, start_idx = 1, max_index = 43384, batch_s = 200, reduce_batch_by = 3, variable_name = "LST_cv_temporal", scale = 50)
...
Para asegurar la continuidad espacial de los análisis, se verifican NAs 
