...
histo_resp <- function(df, var, title, xlab,
  ...
  g <- ggplot(df, aes({{ var }})) +
    ggdist::stat_histinterval(
      fill = pal_qualitat[2], colour = "grey20",
      .width = c(0.5, 0.9),
      bins = bins, binwidth = binwidth
    ) +
    geom_density(aes(y = after_stat(scaled)),
                 colour = "#FFD700", linewidth = 0.8) +
    geom_vline(xintercept = fence_low, linetype = "dashed", colour = "grey20") +
    geom_vline(xintercept = fence_hi,  linetype = "dashed", colour = "grey20") +
...
Se crea una gráfica final para el artículo
...
ggsave(
  here::here("Figures", "var_respuesta_eda.png"),
