# ==========================================================================
# Script: funcion_carga_ucs_armonizadas
# Autor: Carlos Guío
# Insumos: 
...
# Descripción:
# Este script contiene una función para descargar un archivo .gpkg desde Zenodo, 
# detecta la única capa, la carga como objeto `sf`, reporta el CRS y verifica 
...
zenodo_url <- "https://zenodo.org/records/15468384/files/igac_ucs_armonizado.gpkg?download=1"
